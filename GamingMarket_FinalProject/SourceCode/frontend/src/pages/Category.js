...
import { useSearch } from "../context/SearchContext"; // ✅ Search Context eklendi
import {
  Container,
  Grid,
  Typography,
...
function Category() {
  ...
  const { query } = useSearch(); // ✅ Header'daki arama metnini alıyoruz
  ...
  // Backend'den gelen ürünleri, arama kutusuna (query) göre süzüyoruz
